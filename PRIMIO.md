...
*   **Splash Screen:** Black background with a 3D rotating wire-frame ball animation scaled to 75% of screen width, rotating in all directions with depth-shading. Displays "Compass Pro by Primio.dev" title and "Loading..." subtitle below the sphere. Uses a 10-second timeout for initialization.
...
*   **Credits Section:** Displays app version, copyright, disclaimer, and a link to Primio.dev.
...
*   **Clickable Credits Link:** "Primio.dev" in the credits section is now a tappable link that opens the specified URL in the external browser without an underline.
...
*   **Credits Section Styling:** The "Primio.dev" link uses the accent red color and is visually distinct without being underlined.
